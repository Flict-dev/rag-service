...
export const seedArticles = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['Ответ собирается по найденным страницам и показывает, на какие материалы он опирается.'],
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'Черновик',
        paragraphs: ['Редактор создаёт черновик, добавляет владельца, краткое описание и теги для поиска.'],
      },
      {
        heading: 'Ревью',
        paragraphs: ['Администратор или владелец процесса проверяет текст, структуру и область доступа.'],
      },
      {
        heading: 'Публикация',
        paragraphs: [
